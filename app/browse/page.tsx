...
export default function BrowsePage() {
  ...
  return (
    <div className="container py-10">
              ...
              <Card key={item.id}>
                ...
                <CardContent>
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">Owner: {item.seller.name}</p>
                  </div>
                </CardContent>
                <CardFooter>
                  <Button
      ...
      {selectedItem && <BorrowDialog item={selectedItem} open={dialogOpen} onOpenChange={setDialogOpen} />}
    </div>
  )
}
